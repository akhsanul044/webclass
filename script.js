...
const students = [
    ...
    { id: 21, name: "REVA APRILIA EKA PUTRI", role: " . ", quote: "motivasi", ig: "name ig", img: "foto21reva.png" },
    ...
    { id: 24, name: "SALWA LAUKFITASARI", role: " . ", quote: "motivasi", ig: "name ig", img: "foto24salwa.png" },
    ...
    { id: 32, name: "YENI RAHMASARI", role: " . ", quote: "motivasi", ig: "name ig", img: "foto32yeni.png" },
    ...
    { id: 36, name: "MAS RENO DWI", role: " . ", quote: "motivasi", ig: "name ig", img: "foto36reno.png" }
];
...
function renderNodes() {
    ...
    students.forEach(student => {
        ...
        // Catatan: role, quote, dan socials (IG) disembunyikan sementara dengan style="display:none;"
        // Jika nanti ingin dimunculkan kembali, cukup hapus style="display:none;" pada bagian elemen tersebut.
        card.innerHTML = `
